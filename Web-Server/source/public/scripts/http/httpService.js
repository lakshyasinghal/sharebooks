...
$httpService = (function(){
	...
	var SAVE_FEEDBACK = "feedbacks/?";					// feedbacks/user-uid
	var SAVE_COMPLAINT = "complaints/?";                //complaints/user-uid
	...
	function HttpService(){
		...
		this.saveFeedback = httpMethodFactory(REQUEST_TYPE.PUT,SAVE_FEEDBACK,CONTENT_TYPE.JSON);
		this.saveComplaint = httpMethodFactory(REQUEST_TYPE.PUT,SAVE_COMPLAINT,CONTENT_TYPE.FORM);
