...
public class DummyEntitySource {
	...
	private static void generateDummyBooks(){
		Book book1 = new Book(1 , "Physics I by H.C Verma" , "H.C Verma" , "Science" , "Physics" , 228 , 6 , "physics1.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.NOT_AVAILABLE , AvailableStatus.AVAILABLE , 350 , 4 , null , null);
		Book book2 = new Book(2 , "Head First Design Patterns" , "Eric Freeman" , "Computer Science" , "Java" , 654 , 3 , "hfdp.jpg" , AvailableStatus.NOT_AVAILABLE , 
				AvailableStatus.NOT_AVAILABLE , AvailableStatus.AVAILABLE , 300 , 3, null , null);
		Book book3 = new Book(3 , "Head First Java" , "Kathy Sierra & Bert Bates" , "Computer Science" , "Java" , 684 , 2 , "hfj.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.AVAILABLE , AvailableStatus.AVAILABLE , 420 , 5, null , null);
		Book book4 = new Book(4 , "Head First C" , "David Griffiths & Dawn Griffiths" , "Computer Science" , "C" , 588 , 5 , "hfc.jpg" , AvailableStatus.AVAILABLE , 
		...
		Book book8 = new Book(8 , "SSC-CGL" , "GKP" , "Competetive Exam" , "SSC-CGL" , 234 , 3 , "ssc-cgl.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.AVAILABLE , AvailableStatus.AVAILABLE , 100 , 2, null , null);
		Book book9 = new Book(9 , "Physics II by H.C Verma" , "H.C Verma" , "Science" , "Physics" , 237 , 5 , "physics2.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.AVAILABLE , AvailableStatus.AVAILABLE , 150 , 2, null , null);
		Book book10 = new Book(10 , "Java The Complete Reference" , "Herbert Schildt" , "Computer Science" , "Java" , 1116 , 4 , "jtcr.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.NOT_AVAILABLE , AvailableStatus.AVAILABLE , 550 , 1, null , null);
		Book book11 = new Book(11 , "Word Power Made Easy" , "Norman Lewis" , "Literature" , "Vocabulary" , 686 , 4 , "wpme.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.AVAILABLE , AvailableStatus.AVAILABLE , 50 , 2, null , null);
		Book book12 = new Book(12 , "Six Weeks To Words Of Power" , "Wilfred Funk" , "Literature" , "Vocabulary" , 278 , 4 , "swtwop.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.NOT_AVAILABLE , AvailableStatus.AVAILABLE , 60 , 2, null , null);
		Book book13 = new Book(13 , "Head First HTML5 Programming" , "Eric Freeman" , "Computer Science" , "HTML5" , 573 , 1 , "hfhp.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.NOT_AVAILABLE , AvailableStatus.AVAILABLE , 450 , 10, null , null);
		Book book14 = new Book(14 , "Head First Android Development" , "Dawn Griffiths" , "Computer Science" , "Android" , 698 , 1 , "hfad.jpg" , AvailableStatus.AVAILABLE , 
				AvailableStatus.NOT_AVAILABLE , AvailableStatus.AVAILABLE , 500 , 5, null , null);
		Book book15 = new Book(15 , "Mathematics I" , "R.D Sharma" , "Maths" , "Maths" , 568 , 7 , "m1.jpg" , AvailableStatus.AVAILABLE , 
