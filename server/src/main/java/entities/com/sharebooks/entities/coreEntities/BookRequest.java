...
public final class BookRequest extends CoreEntity implements JsonSerializable, JsonDeserializable {
	...
	private String comments; // the comments might be required from the book owner's side when he accepts or
								// rejects the request
	...
	public BookRequest(int id, String uid, BookRequestType type, RequestStatus status, String bookUid,
			String bookOwnerUid, String requesterUid, String quoteUid, String comments, LocalDateTime creationTime,
