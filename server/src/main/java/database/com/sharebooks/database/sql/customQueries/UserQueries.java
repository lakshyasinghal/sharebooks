...
public class UserQueries {
	...
	public String updateSubscriptionStatusByEmail(String email, int subscriptionStatus) {
		StringBuilder query = new StringBuilder();
		query.append("UPDATE ");
		query.append(Table.USERS.desc());
		query.append(" SET ");
	...
	public String updateRegistrationStatusByEmail(String email, int isRegistered) {
		StringBuilder query = new StringBuilder();
		query.append("UPDATE ");
		query.append(Table.USERS.desc());
		query.append(" SET ");
