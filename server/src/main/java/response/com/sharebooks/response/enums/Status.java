...
public enum Status {
	...
	BOOK_DELETED_SUCCESSFULLY(105, "Book deleted successfully."), BOOK_DELETION_FAILED(106, ""),
	BOOK_ALREADY_EXISTS(107, ""), BOOK_UPDATED_SUCCESSFULLY(108, "Book updated successfully."),
	...
	USERNAME_ALREADY_EXISTS(204,
			"The username in the create new user request is already taken.Please use another one."),
	NO_USERS_EXIST(205, "No users exist in database."), USER_UPDATED_SUCCESSFULLY(206, "User updated successfully"),
	...
	FETCH_QUOTE_SUCCESSFUL(601, "Quote fetched successfully."), FETCH_QUOTE_FAILED(602, "Quote could not be fetched."),
	...
	QUOTE_NOT_UPDATED(606, "Quote could not be updated."), FETCH_RESULT_SUCCESSFUL(607, "Result fetched successfully"),
	...
	QUOTE_CONFIRMED(611, "Quote has been confirmed."), QUOTE_NOT_CONFIRMED(612, "Quote could not be confirmed."),
	FETCH_SUMMARY_SUCCESSFUL(613, "Summary fetched successfully."), FETCH_SUMMARY_FAILED(614, ""),

	// status code for payment requests
	FETCH_SUBSCRIPTION_PAYMENT_URL_SUCCESSFUL(701, "FETCH SUBSCRIPTION PAYMENT URL SUCCESSFUL"),
	FETCH_SUBSCRIPTION_PAYMENT_URL_FAILED(702, "FETCH SUBSCRIPTION PAYMENT URL FAILED"),
